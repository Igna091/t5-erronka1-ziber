...
<div class="form-row">
    <div class="form-group">
        ...
        <input type="text" id="name" name="name" class="form-input @error('name') is-invalid @enderror" value="{{ old('name', $student->name ?? '') }}" required maxlength="100" autocomplete="off" placeholder="{{ __('Nombre') }}">
        @error('name')<span class="form-error">{{ $message }}</span>@enderror
    </div>
    <div class="form-group">
        <label for="surname" class="form-label">{{ __('apellidos') }} <span class="req">*</span></label>
        <input type="text" id="surname" name="surname" class="form-input @error('surname') is-invalid @enderror" value="{{ old('surname', $student->surname ?? '') }}" required maxlength="150" autocomplete="off" placeholder="{{ __('Apellidos') }}">
...
<div class="form-row">
    ...
    <div class="form-group">
        <label for="dni" class="form-label">{{ __('dni / nie') }} <span class="req">*</span></label>
