...
@section('title', __('Política de privacidad - ZiberEibar'))
...
<article class="container page-top legal">
    ...
    @includeFirst(['legal.'.app()->getLocale().'.privacy', 'legal.es.privacy'])

    <div class="form-actions" style="margin-top: 1rem;">
        <a href="{{ route('legal.terms') }}" class="link-arrow">{{ __('términos y condiciones') }}</a>
    </div>
</article>
@endsection
