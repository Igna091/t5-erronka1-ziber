...
<head>
    ...
    <title>@yield('title', 'Administración') - EduCenter</title>
    ...
    <div class="admin-layout">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <div>
                    <div class="sidebar-title">EduCenter</div>
            ...
            <header class="admin-header">
                ...
                <div class="admin-header-right">
                    ...
                    <div class="admin-header-user">
                        <div class="admin-header-avatar">{{ auth()->user()->initials ?? 'A' }}</div>
                        <div class="admin-header-info">
                            <div class="admin-header-name">{{ auth()->user()->name ?? 'Admin' }}</div>
                            <div class="admin-header-role">Administrador</div>
                        </div>
                    </div>
                </div>
            </header>
